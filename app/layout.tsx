...
export const metadata: Metadata = {
	...
	category: "finance",
	other: {
		"contact:phone_number": "+48 500 000 000",
		"contact:email": "info@mki-finance.pl",
		"contact:country_name": "Polska",
		"contact:region": "Mazowieckie",
		"business:contact_data:street_address": "ul. Przykładowa 1",
		"business:contact_data:locality": "Warszawa, Mazowieckie",
		"business:contact_data:postal_code": "00-000",
		"business:contact_data:country_name": "Australia",
		"business:contact_data:email": "info@mki-finance.pl",
		"business:contact_data:phone_number": "+48 500 000 000",
